...
class SideNav extends React.Component {
  ...
  render () {
    return (
      ...
      <a href="#" data-activates="slide-out" className="btn-floating btn-large waves-effect waves-light blue button-collapse z-depth-3"><i className="material-icons">menu</i></a>
